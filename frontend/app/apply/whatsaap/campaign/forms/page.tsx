    ...
    const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
        ...
        if (name === 'phone') {
            ...
            if (digitsOnly.length !== 10) {
                setErrors(prev => ({ ...prev, phone: 'Enter 10 digit mobile number' }));
            } else {
        ...
        if (name === 'age') {
            ...
            if (Number(value) < 20) {
                setErrors(prev => ({ ...prev, age: 'Age must be 20 and above' }));
            } else {
    ...
    return (
        <div>
            ...
            <input
                ...
                className="w-full rounded-xl border border-gray-300 px-4 py-3 text-base focus:ring-2 focus:ring-green-500 focus:outline-none"
            />
        </div>
    );
}
