...
export const metadata: Metadata = {
  title: 'Terms of Service | Workspa',
  description: 'Read our terms of service to understand the rules and guidelines for using the Workspa platform.',
  robots: 'index, follow',
};
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 mb-8">
          ...
          <p className="text-gray-600 mt-2">
            Welcome to Workspa. By accessing or using our platform, you agree to be bound by these Terms of Service. 
        ...
        <div className="space-y-6">
          ...
          <section className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
            ...
            <div className="space-y-3 text-gray-700">
              <p>
                By accessing or using Workspa ("the Platform", "we", "us", "our"), you agree to comply with and be bound by 
          ...
          <section className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
            ...
            <div className="space-y-3 text-gray-700">
              <p>
                ...
                are the property of Workspa or its licensors and are protected by copyright, trademark, and other intellectual property laws.
              </p>
              <p>
          ...
          <section className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
            ...
            <div className="space-y-3 text-gray-700">
              <p>
                To the maximum extent permitted by law, Workspa and its affiliates, officers, employees, and agents shall not be 
          ...
          <section className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
            ...
            <p className="text-gray-700">
              You agree to indemnify, defend, and hold harmless Workspa and its affiliates, officers, employees, and agents 
          ...
          <section className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
            ...
            <div className="bg-gray-50 rounded-lg p-4 space-y-2">
              ...
              <p className="text-gray-700">
                <strong>Phone:</strong> <a href="tel:+911234567890" className="text-brand-600 hover:underline">+91 9126458453</a>
              </p>
              <p className="text-gray-700">
