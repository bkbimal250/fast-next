...
export default function ManageSpasPage() {
  ...
  const handleDelete = async (spaId: number) => {
    try {
      ...
      alert(error.response?.data?.detail || 'Failed to delete SPA');
    }
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Manage SPAs</h1>
              <p className="text-gray-600 mt-2">View and manage all spa listings in your system</p>
            </div>
            <Link
              href="/dashboard/spas/create"
              className="inline-flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold px-6 py-3 rounded-lg transition-all shadow-md hover:shadow-lg"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-gray-600">Total SPAs</p>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200 mb-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <select
              ...
              className="border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm"
            >
        ...
        {filteredSpas.length === 0 ? (
          <div className="bg-white rounded-xl shadow-sm p-12 text-center border border-gray-200">
            ...
            {(!searchTerm && filterStatus === 'all' && filterVerified === 'all') && (
              <Link href="/dashboard/spas/create" className="btn-primary inline-flex items-center gap-2">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                </svg>
                Create First SPA
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-4">
                          ...
                          {spa.spa_images && spa.spa_images.length > 0 ? (
                            ...
                            <div className="flex-shrink-0 w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg flex items-center justify-center text-white font-bold text-xl">
                      ...
                      <td className="px-6 py-4">
                        {spa.address ? (
                          <div className="flex items-start gap-2 max-w-xs">
                            ...
                            <span className="text-sm text-gray-600 line-clamp-2" title={spa.address}>
                              {spa.address}
                            </span>
                          </div>
                        ) : (
                              ...
                              {showDeleteConfirm === spa.id ? (
                                <div className="flex items-center gap-1">
                                  <button
                                    ...
                                    className="p-1.5 text-white bg-red-600 hover:bg-red-700 rounded transition-all"
